    ...
    return (
      <div>
          <form onSubmit={handleSubmit}>
              ...
              <input type="text"  onChange={handleEmail} placeholder={"E-mail"} required={true} pattern="[A-Za-z0-9]+@+[a-z0-9]+\.[a-z]+$"/>
              <br/>

              <input type="password" onChange={handlePassword} placeholder={"Password"} required={true} pattern="[A-Za-z0-9]+$"/>
              {
                  showPower ? (
